...
public class ProjetoPOOController implements Initializable {
	@FXML
    private Button bntColmeiaAcao;
	 @FXML
	 private Button bntProducaoAcao;
	 ...
	 @FXML
	    private void initialize() {
	        matriculaFuncionario.textProperty().addListener((observable, oldValue, newValue) -> {
	          colQuantidade.setCellValueFactory(new PropertyValueFactory<Producao, Float>("Quantidade"));
	          colTipo.setCellValueFactory(new PropertyValueFactory<Producao, Integer>("Tipo"));
	          colData.setCellValueFactory(new PropertyValueFactory<Producao, Date>("Data"));
	          colID.setCellValueFactory(new PropertyValueFactory<Producao, Integer>("ID"));

	           AmericanaDAO obj = new AmericanaDAO();
	...
	btnIncluirFuncionario.setDisable(true);
	btnAlterarFuncioario.setDisable(true);
	btnAlterarFuncioario.setDisable(true);
	...
	public void btnColmeiaClicked(ActionEvent event) {
		...
		producao.setVisible(false);
		btnIncluirColmeia.setDisable(true);
		...
		String conteudo = matriculaFuncionario.getText();
		 if (matriculaFuncionario.getText().trim().isEmpty()) {
		        ...
		        try {
		        	...
		        	btnIncluirFuncionario.setDisable(false);
		        	btnAlterarFuncioario.setDisable(false);
		        	btnAlterarFuncioario.setDisable(false);
	...
	public void btnBuscarColmeia(ActionEvent event) {
		...
		if (IDColmeia.getText().trim().isEmpty()) {
			...
			btnIncluirColmeia.setDisable(false);
			btnAlterarColmeia.setDisable(false);
			btnExcluirColmeia.setDisable(false);
	    }catch(NumberFormatException e ) {
